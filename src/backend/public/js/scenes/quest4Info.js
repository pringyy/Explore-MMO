class quest4Info extends Phaser.Scene {
    ...
    setupUiElements () {
        ...
        this.startButton = new UiButton(this, this.scale.width/2, this.scale.height/2*1.6, 'button1', 'button2', 'Accept Quest', this.startScene.bind(this, 'quest4Ui'));
    };
    ...
    endScene(targetScene){
      ...
      startScene(targetScene){
        this.events.emit('questFourActivated');
