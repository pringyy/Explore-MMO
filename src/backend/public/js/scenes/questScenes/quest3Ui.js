...
class quest3Ui extends Phaser.Scene {
    ...
    setupUiElements () {
       ...
       this.objText = this.add.text(35, 8, 'Objective: find the hat at the top of the mountain', { backgroundColor: '	rgb(0, 0, 0)', fontSize: '16px', fill: '#fff' });this.objText.alpha = 0.7;
