...
class quest1Info extends Phaser.Scene {
    ...
    setupUiElements () {
        ...
        this.quitButton = new button(this, this.scale.width/2 * 1.7, this.scale.height/2  * 0.6, 'cross1', 'cross2', '', this.endScene.bind(this, 'quest1Info')).setScale(0.7);
        ...
        if (!this.complete){
            ...
            this.startButton = new button(this, this.scale.width/2, this.scale.height/2*1.4, 'button1', 'button2', 'Accept Quest', this.startScene.bind(this, 'quest1Ui'));
        }else{
